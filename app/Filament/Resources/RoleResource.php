...
use App\Filament\Resources\RoleResource\Pages\ManageProjects;
...
class RoleResource extends Resource implements HasShieldPermissions
{
    ...
    protected static string|UnitEnum|null $navigationGroup = 'کاربران سیستم';
